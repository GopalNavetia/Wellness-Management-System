...
export default function EditTrainer() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                alert('Failed to edit trainer: ' + response.data.message);
            }
        } catch (error) {
            ...
            if (error.response?.data?.message) {
                ...
                alert('Failed to edit trainer (network error)');
            }
        }
    };
    ...
    return (
        <div className="editTrainerContainer">
            <div className="editTrainerHeadSection">
                <h1>Edit Trainer</h1>
            ...
            <form className="formContainer" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <select name="status" value={formData.status} id="status" onChange={handleInputChange}>
                        <option value="">Choose</option>
