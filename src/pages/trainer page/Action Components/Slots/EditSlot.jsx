...
export default function EditSlot() {
    ...
    let handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                alert('Failed to edit slot: ' + response.data.message);
            }
    ...
    return (
        <div className="editSlotRecord">
            <div className="editSlotRecordHeadSection">
                <h1>Edit Slot Record</h1>
