...
export default function AddSalary() {
    ...
    let handleSubmit = async (e) => {
        ...
        try {
            const response = await axiosInstance.post(`/MyProject/AddSalaryAPI?id=${trainerID}`, formData, {
                headers: {
            ...
            if (response.data.success) {
                alert("Add Salary Successful.")
                handleReset();
                navigate(-1);
            } else {
                alert('Failed to add salary: ' + response.data.message);
            }
    ...
    return (
        <div className="addSalaryRecord">
            <div className="addSalaryRecordHeadSection">
